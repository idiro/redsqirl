 ...
 *
 */
public class MrqlSampleInteraction extends InputInteraction{
	 ...
	 */
	public MrqlSampleInteraction(String id, String name, String legend,
	...
	public String check(){
		...
		try{
			...
			if(sample < 0 || sample > 1){
				error = MrqlLanguageManager.getText("mrql.sample_interaction.not_inrange");
			}
		}catch(Exception e){
			error = MrqlLanguageManager.getText("mrql.sample_interaction.not_double");
		}
		return error;
	}
	/**
