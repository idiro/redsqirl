...
/**
 * Interaction for storing/checking Mrql Latin filter condition.
 * 
 * @author marcos
 * 
 */
public class MrqlFilterInteraction extends SqlFilterInteraction {
	 ...
	 */
	public MrqlFilterInteraction(int column,
	...
	protected Tree<String> generateEditor() throws RemoteException{
		return MrqlDictionary.generateEditor(MrqlDictionary.getInstance()
	...
	public String getInputWhere() throws RemoteException {
		String where = "";
		List<DFEOutput> out = el.getDFEInput().get(MrqlElement.key_input);
