...
public class PigDictionaryTests {
	...
	public void isBoolean(String expr, FieldList fields) throws Exception {
		assertTrue(expr,
				PigDictionary.getInstance().getReturnType(expr, fields)
						.equalsIgnoreCase("boolean"));
	}

	public void isNotBoolean(String expr, FieldList fields)
			throws Exception {
		String ans = PigDictionary.getInstance().getReturnType(expr, fields); 
		assertFalse(expr,
	...
	public void isNull(String expr, FieldList fields) throws Exception {
		try {
			assertTrue(
					expr,
					PigDictionary.getInstance().getReturnType(expr, fields) == null);
		} catch (Exception e) {
		}
	}
	...
	public void is(String expr, FieldList fields, Set<String> agg,
		...
		assertTrue(expr,
				PigDictionary.getInstance().getReturnType(expr, fields, agg)
						.equalsIgnoreCase(type));
	}
