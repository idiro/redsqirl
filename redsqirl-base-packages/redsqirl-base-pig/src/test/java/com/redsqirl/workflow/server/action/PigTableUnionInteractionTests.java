	...
	public void basic(){
		...
		try{
			...
			}
			{
				...
				logger.debug("4");
				rowId.add(PigTableUnionInteraction.table_table_title).add(alias1);
			...
			}
			{
				...
				logger.debug("5");
				rowId = out.add("row");
				rowId.add(PigTableUnionInteraction.table_table_title).add("test_redsqirl_3");
			...
			}
			{
				...
				logger.debug("5");
				rowId = out.add("row");
				rowId.add(PigTableUnionInteraction.table_table_title).add(alias2);
