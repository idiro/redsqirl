...
public class PigSchemaTests {
	...
	public void basic(){
		...
		try{
			...
			logger.info("path1 " + new_path1);
			logger.info("path2 " + new_path2);
			...
			{
				Tree<String> field = dataSetTree.getFirstChild("browse")
						.getFirstChild("output").add("field");
				field.add("name").add("ID");
				field.add("type").add("STRING");
			}
			{
				Tree<String> field = dataSetTree.getFirstChild("browse")
						.getFirstChild("output").add("field");
				field.add("name").add("VALUE");
				field.add("type").add("INT");
			}
