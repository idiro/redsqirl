...
public interface DataStoreArray extends Remote{
	...
	/**
	 * Get the fields needed for initiating a DataStore.
	 * The key is the field name and the value a help comment. 
	 * @return
	...
	/**
	 * Get the fields needed for removing a known DataStore.
	 * The key is the field name and the value a help comment.
	 * @return
	 * @throws RemoteException
	 */
	...
	/**
	 * Add a DataStore into memory.
	 * The class does not save the details of this DataStore.
	 * The input parameters are described in {@link #getFieldsInitNeeded()}
	 * @param fields
	 * @return The name of the new store
	 * @throws RemoteException
	 */
	String addStore(Map<String,String> fields) throws Exception,RemoteException;
	...
	/**
	 * Initiate the known store list.
	 * The methods return an error message or null.
	 * To get the stores, see {@link #getKnownStoreDetails()}
	 * @return
	 * @throws RemoteException
	 */
	...
	/**
	 * Add a store to a permanent list.
	 * The fields needed for this method are describe in {@link #getFieldsInitNeeded()}
	 * @param fields
	 * @return
	 * @throws RemoteException
	 */
	...
	/**
	 * Remove a known store from the permanent list.
	 * The fields needed for this method are described in {@link #getFieldsToRemove()}
	 * @param fields
	 * @return
	 * @throws RemoteException
	 */
