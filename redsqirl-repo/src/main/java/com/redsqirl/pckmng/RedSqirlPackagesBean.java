...
@Path("allpackages")
public class RedSqirlPackagesBean {

	//@Context 
	//ServletContext context;
	
	//resource injection
    //@Resource(name="jdbc/redsqirl_pck_mng")
	private DataSource ds;
	
	private static Logger logger = Logger.getLogger(RedSqirlPackagesBean.class);
	
	private String download_url;
	
	//if resource inject is not support, you still can get it manually.
	public RedSqirlPackagesBean(){
	...
	public List<RedSqirlPackage> getPackageList(@QueryParam("id") String packageId,
		...
		List<RedSqirlPackage> list = new ArrayList<RedSqirlPackage>();
