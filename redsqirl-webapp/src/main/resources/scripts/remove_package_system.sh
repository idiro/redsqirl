...
if [ -z $PACKAGE_NAME ]; then
	echo "This script takes for argument the the package name to uninstall"
	exit
fi
...
JAVA_PATH=java
$JAVA_PATH -server -classpath $CLASSPATH $MAIN_CLASS remove system ${SCRIPT_PATH}/.. $PACKAGE_NAME
